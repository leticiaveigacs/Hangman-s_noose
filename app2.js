...
const categorias = {
  /*   Animais: ['abelha', 'pato', 'salamandra','tartaruga', 'vaca','passaro'],
    ...
    Astrologico:['sol', 'lua','cometa','saturno','estrelas', 'planeta'],
    Formas_Geometricas:['losângulo','circulo','triângulo', 'quadrado', 'retângulo'],
    //Filmes:['Marley e Eu','Paixão de Cristo','Harry Potter', 'Shreck', ''],
    Paises:['Brasil','Portugal','Argentina', 'China', 'Equador', 'Espanha'],
    Emoçoes:['feliz','triste','raiva', 'fome', 'alegre', 'espantado'] */

    Animals: ['bee', 'ducK', 'salamander', 'turtle', 'cow', 'bird'],
    Objects: ['desk','tap','mousetrap','dice', 'pen'],
    //Places: [‘school’, ‘mountain’, ,‘house’],
    Food: ['cheese', 'omelette', 'strawberry', 'yoghurt', 'soup', 'fish', 'chocolate'],
    Transport: ['ship','car','truck','train','metro'],
    Professions: ['journalist', 'dentist', 'engineer', 'model', 'fisherman'],
    Music: ['harmonica','guitar', 'drums', 'singer','piano'],
    Astrological: ['sun', 'moon','comet','saturn','stars','planet'],
    Geometric_Shapes:['rhombus', 'circle','triangle','square', 'rectangle'],
    //Movies:[‘Marley and Me’,‘Passion of the Christ’,‘Harry Potter’,‘Shreck’, ‘’],
    Countries:['Brazil','Portugal','Argentina', 'China', 'Ecuador', 'Spain'],
    Lunches:['happy','sad','angry', 'hungry', 'happy', 'amazed']
...
function atualizarExibicao() {
    ...
    if (tentativasRestantes === 0) {
        encerrarJogo('YOU ARE DEAD!');
    } else if (!exibicaoPalavra.includes('_')) {
        encerrarJogo('Congratulations! You have won!');
    }
}
...
function chutarLetra() {
    ...
    if (letrasChutadas.includes(letra)) {
        alert('You have already tried this font. Try another.');
        return;
    }
